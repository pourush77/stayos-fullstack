...
describe('GuestsController', () => {
  ...
  it('delegates create requests to the service', async () => {
    ...
    await expect(controller.create(propertyId, payload)).resolves.toEqual(guestResponse);
  ...
  it('delegates get-by-id requests to the service', async () => {
    ...
    await expect(controller.findOne(propertyId, guestId)).resolves.toEqual(guestResponse);
